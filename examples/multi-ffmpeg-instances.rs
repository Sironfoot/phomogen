...
fn main() {
    ...
    for thread_index in 0..NUM_THREADS {
        ...
        workers.push(thread::spawn(move || {
            let frame_crops = CropSetting::all_crops(RESIZE_WIDTH, RESIZE_HEIGHT, GRIDS_X, GRIDS_Y);
...
impl CropSetting {
    fn new(resize: f64, pos_x: f64, pos_y: f64, full_width: u32, full_height: u32, grids_x: u32, grids_y: u32) -> Self {
        ...
        let mut tiles: Vec<CropTile> = Vec::with_capacity((grids_x * grids_y) as usize);

        for grid_y in 0..grids_y {
            for grid_x in 0..grids_x {
                let start_x = crop_start_x + (cropped_grid_width * grid_x);
                let end_x = cmp::min(start_x + cropped_grid_width, full_width);

                let start_y = crop_start_y + (cropped_grid_height * grid_y);
                let end_y = cmp::min(start_y + cropped_grid_height, full_height);
    ...
    fn all_crops(full_width: u32, full_height: u32, grids_x: u32, grids_y: u32) -> Vec<Self> {
        vec![
            // full frame
            Self::new(100.0, 0.0, 0.0, full_width, full_height, grids_x, grids_y), // full frame

            // 50% crops
            Self::new(50.0, 0.0, 0.0, full_width, full_height, grids_x, grids_y),   // top left
            Self::new(50.0, 25.0, 0.0, full_width, full_height, grids_x, grids_y),  // top
            Self::new(50.0, 50.0, 0.0, full_width, full_height, grids_x, grids_y),  // top right
            Self::new(50.0, 0.0, 25.0, full_width, full_height, grids_x, grids_y),  // left
            Self::new(50.0, 25.0, 25.0, full_width, full_height, grids_x, grids_y), // center
            Self::new(50.0, 50.0, 25.0, full_width, full_height, grids_x, grids_y), // right
            Self::new(50.0, 0.0, 50.0, full_width, full_height, grids_x, grids_y),  // bottom left
            Self::new(50.0, 25.0, 50.0, full_width, full_height, grids_x, grids_y), // bottom
            Self::new(50.0, 50.0, 50.0, full_width, full_height, grids_x, grids_y), // bottom right

            // 50% inner crops
            Self::new(50.0, 12.5, 12.5, full_width, full_height, grids_x, grids_y), // inner top left
            Self::new(50.0, 37.5, 12.5, full_width, full_height, grids_x, grids_y), // inner top right
            Self::new(50.0, 12.5, 37.5, full_width, full_height, grids_x, grids_y), // inner bottom left
            Self::new(50.0, 37.5, 37.5, full_width, full_height, grids_x, grids_y), // inner bottom right

            // 66.666% crops
            Self::new(66.666, 0.0, 0.0, full_width, full_height, grids_x, grids_y),       // top left
            Self::new(66.666, 16.666, 0.0, full_width, full_height, grids_x, grids_y),    // top
            Self::new(66.666, 33.333, 0.0, full_width, full_height, grids_x, grids_y),    // top right
            Self::new(66.666, 0.0, 16.666, full_width, full_height, grids_x, grids_y),    // left
            Self::new(66.666, 16.666, 16.666, full_width, full_height, grids_x, grids_y), // center
            Self::new(66.666, 33.333, 16.666, full_width, full_height, grids_x, grids_y), // right
            Self::new(66.666, 0.0, 33.333, full_width, full_height, grids_x, grids_y),    // bottom left
            Self::new(66.666, 16.666, 33.333, full_width, full_height, grids_x, grids_y), // bottom
            Self::new(66.666, 33.333, 33.333, full_width, full_height, grids_x, grids_y), // bottom right
        ]
    }
}